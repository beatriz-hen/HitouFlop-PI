...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07/03/2025 às 00:53
...
CREATE TABLE `tb_lista` (
  ...
  `notaEpisodio` char(2) DEFAULT NULL,
  `episodios` int(5) DEFAULT NULL,
  `status` varchar(1) NOT NULL,
  `comentarioMidia` varchar(255) DEFAULT NULL,
  `comentarioEpisodio` varchar(255) DEFAULT NULL,
...
ALTER TABLE `tb_midia`
  ...
  ADD CONSTRAINT `FK_idGenero` FOREIGN KEY (`idGenero`) REFERENCES `tb_genero` (`idGenero`),
